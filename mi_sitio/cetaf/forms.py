...
class ActivoForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'fecha_compra': forms.DateInput(attrs={'class': 'uk-input', 'type': 'date'}, format='%Y-%m-%d'),
            ...
            'fecha_puesto_servicio': forms.DateInput(attrs={'class': 'uk-input', 'type': 'date'}, format='%Y-%m-%d'),
            'descripcion': forms.Textarea(attrs={'class': 'uk-textarea'}),
...
class AsignacionForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'fecha_inicio': forms.DateInput(attrs={'class': 'uk-input', 'type': 'date'}, format='%Y-%m-%d'),
            'fecha_fin': forms.DateInput(attrs={'class': 'uk-input', 'type': 'date'}, format='%Y-%m-%d'),
            'descripcion': forms.Textarea(attrs={'class': 'uk-textarea'}),
        }
        labels = {
